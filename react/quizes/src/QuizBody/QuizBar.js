...
function QuizBar(Quiz,page){
    ...
    introBar = (
        <div className = "quizIntroBar">
            ...
            <p className = "introText">Following one is created by <button className = "introUser">{Quiz.authorID}</button> date : {Quiz.dateCreated}</p>
            <p className = "introText">Quiz category : {Quiz.categoryID}</p>
